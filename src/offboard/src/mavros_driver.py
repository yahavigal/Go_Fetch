...
class mavros_driver():
    def __init__(self, nh):
        ...
        # subscriber,
        #self.local_pose = PoseStamped() #Y
        #rospy.Subscriber('/mavros/local_position/pose', PoseStamped, self._local_pose_cb) #Y
        #self.local_vel = TwistStamped() #Y
        #rospy.Subscriber('/mavros/local_position/velocity', TwistStamped, self._local_vel_cb) #Y
    ...
    #def _local_pose_cb(self, data): #Y
        #self.local_pose = data #Y
        
    #def _local_vel_cb(self, data): #Y
        #self.local_vel = data #Y
